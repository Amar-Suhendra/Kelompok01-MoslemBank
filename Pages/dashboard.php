  ...
  <div class="row">
    <div class="col-xl-6 col-md-12">
      <div class="card shadow">
        <div class="card-header">
          <h4>Sedekah Bulan ini</h4>
        </div>
        <div class="card-body">
          <?php if ($total_donation_this_month == null) {
            echo '<h5>Tidak Ada Sedekah Bulan ini</h5>';
          } else { ?>
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th><?php echo 'Rp. ' . number_format($total_donation_this_month, 0, ',', '.'); ?>
                  </th>
                </tr>
              </tbody>
            </table>
    ...
    <div class="col-xl-6 col-md-12">
      <div class="card shadow">
        ...
        <div class="card-body">
          <?php if ($total_expenses_this_month == null) {
            echo '<h5>Tidak Ada Pengeluaran Bulan ini</h5>';
          } else { ?>
            <table class="table table-bordered">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  <th colspan="3">Total</th>
                  <th><?php echo 'Rp. ' . number_format($total_expenses_this_month, 0, ',', '.'); ?>
                  </th>
                  </td>
                </tr>
              </tbody>
