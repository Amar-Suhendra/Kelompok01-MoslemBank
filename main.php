  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      >
        ...
        <!-- Nav Item - Pages -->
        <li class="nav-item">
          <a class="nav-link" href="?page=sedekah" aria-expanded="true">
        ...
        <!-- Nav Item - Pages -->
        <li class="nav-item">
          <a class="nav-link" href="?page=pengeluaran" aria-expanded="true">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            if ($page == 'sedekah') {
                if ($aksi == '') {
                    include 'Pages/Sedekah/sedekah.php';
                } elseif ($aksi == 'tambah') {
                    include 'Pages/Sedekah/sedekah_tambah.php';
                } elseif ($aksi == 'edit') {
                    include 'Pages/Sedekah/sedekah_edit.php';
                } elseif ($aksi == 'hapus') {
                    include 'Pages/Sedekah/sedekah_hapus.php';
                }
            } elseif ($page == 'pengeluaran') {
                if ($aksi == '') {
                    include 'Pages/Pengeluaran/pengeluaran.php';
                } elseif ($aksi == 'tambah') {
                    include 'Pages/Pengeluaran/pengeluaran_tambah.php';
                } elseif ($aksi == 'edit') {
                    include 'Pages/Pengeluaran/pengeluaran_edit.php';
                } elseif ($aksi == 'hapus') {
